...
import { DashboardStatsItem, ContentItem } from "../../models/Dashboard";
...
export const Dashboard: React.FC = () => {
  ...
  const renderContentList = (
    ...
    try {
      ...
      return <div className="text-red-500 text-sm">Error loading content</div>;
    }
  };
  ...
  try {
    return (
      <div className="space-y-6">
        ...
        {/* Stats Grid */}
        <DashboardStats
          stats={dashboardData?.stats?.map((stat: DashboardStatsItem) => ({
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                {renderContentList(
                  dashboardData.mostCommented.trips,
                  "trips",
                  "comments"
                )}
              </div>
              <div>
                ...
                {renderContentList(
                  dashboardData.mostCommented.itineraries,
                  "itineraries",
                  "comments"
                )}
              </div>
              <div>
                ...
                {renderContentList(
                  dashboardData.mostCommented.destinations,
                  "destinations",
                  "comments"
                )}
              </div>
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                {renderContentList(
                  dashboardData.mostLiked.itineraries,
                  "itineraries",
                  "likes"
                )}
              </div>
              <div>
                ...
                {renderContentList(
                  dashboardData.mostLiked.destinations,
                  "destinations",
                  "likes"
                )}
              </div>
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                {renderContentList(
                  dashboardData.mostSaved.itineraries,
                  "itineraries",
                  "saves"
                )}
              </div>
              <div>
                ...
                {renderContentList(
                  dashboardData.mostSaved.destinations,
                  "destinations",
                  "saves"
                )}
              </div>
